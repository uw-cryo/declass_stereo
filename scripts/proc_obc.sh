...
point2dem $pc_init --t_srs $epsg --tr $coarse_tr
...
point2dem $pc_ex --t_srs $epsg --tr $coarse_tr 
...
#Create final gridded DEM at fine resolution
point2dem $pc_in --t_srs $epsg --tr $fine_tr
